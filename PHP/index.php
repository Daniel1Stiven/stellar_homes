...
<body>
    ...
    <div class="menu-bar">
        ...
        <a href="./inmueblesIN.php">
            <button class="dropbtn">Inmuebles</button>
        </a>
        <a href="../NosotrosIN.html">
    ...
    <section class="search">
        ...
        <form action="./Buscar inmueble/crear.php" method="POST">
        ...
        <?php foreach ($rows as $row): ?>
            <div class="property">
                ...
                <div class="property-info">
                    ...
                    <a href="../Iniciar Sesión.html" class="contact-button">
                    <button onclick="alert('Tienes que Iniciar Sesion, para  ver este inmueble');">Ver mas</button>
                        </a>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
    <a href="./inmueblesIN.php" class="view-more">Ver más propiedades</a>
</section>
