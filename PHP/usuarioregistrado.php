...
<body>
        ...
        <?php foreach ($rows as $row): ?>
            <div class="property">
                ...
                <div class="property-info">
                    <p><strong>idInmueble:</strong> <?php echo htmlspecialchars($row['idInmueble']); ?></p>
                    ...
                    <a href="inmuebleid.php?id=<?php echo htmlspecialchars($row['idInmueble']); ?>">
    ...
    <a href="inmuebleUS.php" class="view-more">Ver más propiedades</a>
</section>
